          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                >
                  <Icon name="phone" size="sm" className="mr-3" />
                ...
                <a
                  ...
                  className="flex items-center text-slate-300 hover:text-emerald-400 transition-colors"
                >
                  <Icon name="email" size="sm" className="mr-3" />
                  {companyInfo.contact.email}
                </a>
                <div className="flex items-start text-slate-300">
                  <Icon name="map" size="sm" className="mr-3 mt-1 flex-shrink-0" />
                  <span>
            ...
            {/* Products */}
            <div>
              <h3 className="font-bold text-white mb-4">Producten</h3>
            ...
            {/* Opening hours */}
            <div>
              <h3 className="font-bold text-white mb-4">Openingstijden</h3>
              <div className="space-y-4">
                <div>
                  <p className="text-emerald-400 text-sm font-medium mb-2">Showroom</p>
                  <ul className="space-y-1">
                    {companyInfo.openingHours.showroom.map((item, index) => (
                      <li key={index} className="text-slate-400 text-sm flex justify-between">
                        <span>{item.days}</span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-slate-400 hover:bg-emerald-600 hover:text-white transition-colors"
                aria-label="Facebook"
              >
